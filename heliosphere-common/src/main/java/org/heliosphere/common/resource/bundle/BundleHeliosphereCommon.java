...
/**
 * Enumeration of the resource bundle externalized string of the <b>heliosphere common</b> module. 
...
public enum BundleHeliosphereCommon implements IBundle
{
	 ...
	 */
	private BundleHeliosphereCommon(final String key)
	{
		this.key = key;
	}
	...
	{
		if (!key.equals(BundleHeliosphereCommon.BundleRoot.key) && !key.equals(BundleHeliosphereCommon.BundleFilename.key))
		{
			return BundleHeliosphereCommon.BundleRoot.getKey() + key;
		}
